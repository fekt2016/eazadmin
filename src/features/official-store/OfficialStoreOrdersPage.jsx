...
export default function OfficialStoreOrdersPage() {
  const navigate = useNavigate();
  const { useGetOfficialStoreOrders } = useOfficialStore();
  const { data: ordersList, isLoading, error } = useGetOfficialStoreOrders();
  ...
  if (error) {
    return (
      <ErrorContainer>
        ...
        <h3>Failed to load Official Store orders</h3>
