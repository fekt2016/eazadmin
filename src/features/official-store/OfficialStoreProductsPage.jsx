    ...
    <DashboardContainer>
      ...
      {filteredProducts.length === 0 ? (
        <NoResultsContainer>
          ...
          <NoResultsMessage>
            {products.length === 0
              ? "You haven't created any Official Store products yet. Create your first Official Store product to get started!"
              : `Try adjusting your search or filter. You have ${products.length} total Official Store products.`}
          </NoResultsMessage>
          {products.length === 0 && (
            <NoResultsAction>
              <CreateButton onClick={() => navigate(`/dashboard/${PATHS.OFFICIAL_STORE_PRODUCTS_NEW}`)}>
