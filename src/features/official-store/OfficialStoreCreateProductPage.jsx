...
const OFFICIAL_STORE_SELLER = { id: "official-store" };

export default function OfficialStoreCreateProductPage() {
  const navigate = useNavigate();
  const { useCreateOfficialStoreProduct } = useOfficialStore();
  const createMutation = useCreateOfficialStoreProduct();
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      ...
      toast.success("Official Store product created");
    ...
    <PageContainer>
      <HeaderContainer>
        <BackButton type="button" onClick={() => navigate(`${basePath}/products`)}>
          <FaArrowLeft /> Back to Official Store products
        </BackButton>
        <PageTitle>Add Official Store product</PageTitle>
        <HeaderDescription>
